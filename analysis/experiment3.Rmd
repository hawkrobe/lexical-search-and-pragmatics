...
```{r}
e3_data = read_csv(here("data/exp3/e3_data_corrected.csv")) %>% 
...
e3_nonRSA = read_csv(here("data/exp3/e3_nonRSAprobs.csv")) %>% 
  mutate(alpha = as.character(alpha), model = "nonRSA")
e3_RSA = read_csv(here("data/exp3/RSAprobs.csv")) %>% 
  mutate(alpha = "RSA", model = "RSA")
...
ggsave(here("analysis/plots/exp3_plot.pdf"), e3_plot)
